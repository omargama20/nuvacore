...
2. Envía `https://nuvacore.mx/sitemap.xml`.
...
## Dominio oficial
El dominio canónico del proyecto es `https://nuvacore.mx/`. Configura `www.nuvacore.mx` como CNAME hacia `omargama20.github.io`.
